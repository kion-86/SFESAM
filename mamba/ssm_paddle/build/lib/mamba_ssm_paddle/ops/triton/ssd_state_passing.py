...
def _state_passing_fwd(states, dA_chunk_cumsum, initial_states=None, seq_idx=None, chunk_size=None,
    ...
    _state_passing_fwd_kernel[grid](
        ...
        final_states.strides[0], final_states.strides[1], final_states.strides[2],
        dA_chunk_cumsum.strides[0], dA_chunk_cumsum.strides[2], dA_chunk_cumsum.strides[1],
...
def _state_passing_bwd(
    ...
    ddA_chunk_cumsum = paddle.empty([batch, nheads, nchunks, n_blocks],
    ...
    _state_passing_bwd_kernel[grid](
        ...
        *((seq_idx.strides[0], seq_idx.strides[1]) if seq_idx is not None else (0, 0)),
        dstates.strides[0], dstates.strides[1], dstates.strides[2], dstates.strides[3],
        ddA_chunk_cumsum.strides[0], ddA_chunk_cumsum.strides[2], ddA_chunk_cumsum.strides[1],
