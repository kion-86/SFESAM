...
def _chunk_scan_fwd(cb, x, dt, dA_cumsum, C, states, D=None, z=None, seq_idx=None):
    ...
    z_strides = ((z.strides[0], z.strides[1], z.strides[2], z.strides[3])
                  if z is not None else (0, 0, 0, 0))
    _chunk_scan_fwd_kernel[grid](
        cb, x, z, out, out_x, dt, dA_cumsum, seq_idx, C, states, D,
        chunk_size, headdim, dstate,
        batch, seqlen, nheads // ngroups,
        cb.strides[0], cb.strides[1], cb.strides[2], cb.strides[3], cb.strides[4],
        ...
        *((seq_idx.strides[0], seq_idx.strides[1]) if seq_idx is not None else (0, 0)),
        C.strides[0], C.strides[1], C.strides[2], C.strides[3],
        states.strides[0], states.strides[1], states.strides[2], states.strides[3], states.strides[4],
...
def _chunk_scan_bwd_dz(x, z, out, dout, chunk_size, has_ddAcs=True, D=None, dz=None, recompute_output=False):
    ...
    _chunk_scan_bwd_dz_kernel[grid_dz](
        ...
        *((outz.strides[0], outz.strides[1], outz.strides[2], outz.strides[3]) if recompute_output else (0, 0, 0, 0)),
        dz.strides[0], dz.strides[1], dz.strides[2], dz.strides[3],
        dout_x.strides[0], dout_x.strides[1], dout_x.strides[2], dout_x.strides[3],
...
def _chunk_scan_bwd_dstates(C, dA_cumsum, dout, seq_idx=None, dtype=None):
    ...
    _chunk_scan_bwd_dstates_kernel[grid_dstates](
        ...
        dout.strides[0], dout.strides[1], dout.strides[2], dout.strides[3],
        C.strides[0], C.strides[1], C.strides[2], C.strides[3],
        dprev_states.strides[0], dprev_states.strides[1], dprev_states.strides[2], dprev_states.strides[3], dprev_states.strides[4],
        dA_cumsum.strides[0], dA_cumsum.strides[2], dA_cumsum.strides[1], dA_cumsum.strides[3],
        *((seq_idx.strides[0], seq_idx.strides[1]) if seq_idx is not None else (0, 0)),
        HAS_SEQ_IDX=seq_idx is not None,
    )
...
def _chunk_scan_bwd_dC(prev_states, dA_cumsum, dout, seq_idx=None, C=None, ngroups=1):
    ...
    if C is not None:
        ...
        ddA_cumsum_prev_strides = (ddA_cumsum_prev.strides[0], ddA_cumsum_prev.strides[2], ddA_cumsum_prev.strides[1], ddA_cumsum_prev.strides[3])
    else:
        C_strides = (0, 0, 0, 0)
    ...
    _chunk_scan_bwd_dc_kernel[grid_dc](
        ...
        batch, seqlen, nheads, nheads_per_program, ngroups,
        dout.strides[0], dout.strides[1], dout.strides[2], dout.strides[3],
        prev_states.strides[0], prev_states.strides[1], prev_states.strides[2], prev_states.strides[3], prev_states.strides[4],
        *C_strides,
        dA_cumsum.strides[0], dA_cumsum.strides[2], dA_cumsum.strides[1], dA_cumsum.strides[3],
        *((seq_idx.strides[0], seq_idx.strides[1]) if seq_idx is not None else (0, 0)),
        dC.strides[0], dC.strides[1], dC.strides[2], dC.strides[3], dC.strides[4],
...
def _chunk_scan_bwd_dcb(x, dt, dA_cumsum, dout, seq_idx=None, CB=None, ngroups=1):
    ...
    if CB is not None:
        ...
        BLOCK_SIZE_M_min = 16
        ddA_cumsum = paddle.empty([batch, nheads, nchunks, triton.cdiv(chunk_size, BLOCK_SIZE_M_min),
                                chunk_size], dtype=paddle.float32)
        ddA_cumsum_strides = (ddA_cumsum.strides[0], ddA_cumsum.strides[2], ddA_cumsum.strides[1], ddA_cumsum.strides[3], ddA_cumsum.strides[4])
    else:
    ...
    _chunk_scan_bwd_dcb_kernel[grid_dcb](
        ...
        *CB_strides,
        ...
        dA_cumsum.strides[0], dA_cumsum.strides[2], dA_cumsum.strides[1], dA_cumsum.strides[3],
        *((seq_idx.strides[0], seq_idx.strides[1]) if seq_idx is not None else (0, 0)),
        dcb.strides[0], dcb.strides[1], dcb.strides[2], dcb.strides[3], dcb.strides[4], dcb.strides[5],
        *ddA_cumsum_strides,
...
def _chunk_scan_bwd_ddAcs_stable_old(x, dt, dA_cumsum, dout, cb):
    ...
    _chunk_scan_bwd_ddAcs_stable_kernel_old[grid_ddtcs](
        ...
        dA_cumsum.strides[0], dA_cumsum.strides[2], dA_cumsum.strides[1], dA_cumsum.strides[3],
        cb.strides[0], cb.strides[1], cb.strides[2], cb.strides[3], cb.strides[4],
        ddA_cumsum.strides[0], ddA_cumsum.strides[2], ddA_cumsum.strides[1], ddA_cumsum.strides[3], ddA_cumsum.strides[4],
        BLOCK_SIZE_K=max(triton.next_power_of_2(headdim), 16),
...
def _chunk_scan_bwd_ddAcs_prev(prev_states, C, dout, dA_cumsum, seq_idx=None):
    ...
    _chunk_scan_bwd_ddAcs_prev_kernel[grid_ddAcs](
        ...
        dA_cumsum.strides[0], dA_cumsum.strides[2], dA_cumsum.strides[1], dA_cumsum.strides[3],
        *((seq_idx.strides[0], seq_idx.strides[1]) if seq_idx is not None else (0, 0)),
        ddA_cumsum_prev.strides[0], ddA_cumsum_prev.strides[2], ddA_cumsum_prev.strides[1], ddA_cumsum_prev.strides[3],
        HAS_SEQ_IDX=seq_idx is not None,
        BLOCK_SIZE_K=max(triton.next_power_of_2(headdim), 16),
    )
...
def chunk_scan_ref(B, C, x, dt, dA_cumsum, prev_states, D=None, z=None):
    ...
    CB = paddle.einsum("bclhn,bcshn->bchls", rearrange(C, "b (c l) h n -> b c l h n", c=nchunks),
    ...
    out = paddle.einsum('bchls,bhcs,bcshp->bclhp', scores_decay.cast(x.dtype), dt.cast(x.dtype),
                       rearrange(x, "b (c s) h p -> b c s h p", c=nchunks))
    state_decay_out = paddle.exp(rearrange(dA_cumsum, "b h c l -> b c l h 1"))
    out_prev = paddle.einsum('bclhn,bchpn->bclhp', rearrange(C, "b (c l) h n -> b c l h n", c=nchunks),
                            prev_states.cast(C.dtype)) * state_decay_out
    out = out + out_prev
